...
use crate::event::{Button, Event, EventHandler, Screen};
use crate::ui;
...
impl EventHandler for SettingsScreen {
    fn event_queue(&mut self) -> &mut crate::event::EventQueue {
        &mut self.events
    }

    fn handle_event(&mut self, event: &Event) -> heapless::Vec<Event, 8> {
